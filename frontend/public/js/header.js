...
(function () {
  ...
  function injectHeader() {
    ...
    //    on s'y branche uniquement (bindings, thème, i18n) sans réinjection.
    //  - Pages HTML classiques : injection du template comme avant.
    const staticHeader = document.querySelector('header.header[data-static]');
    if (!staticHeader) {
